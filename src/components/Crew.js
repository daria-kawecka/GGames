      ...
      <div className="crewSection__container" ref={scene}>
        <div className="crewSection__crewMember">
          ...
          <p className="crewSection__crewMember--text">
            <span className="crewSection__crewMember--character">
              Our chARRRacter master
            </span>
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Harum,
            laudantium tempora. Reprehenderit saepe consequatur necessitatibus
            quia iure expedita quos quod ad eos est! Debitis nam doloremque quod
            tenetur amet pariatur.
          </p>
        </div>
        <div className="crewSection__crewMember">
